...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(GPIOE, GPIO_PIN_3|GPIO_PIN_4|GPIO_PIN_5|GPIO_PIN_6
                          |OE1_Pin|GPIO_PIN_9|OE3_Pin|GPIO_PIN_11
                          |OE4_Pin|GPIO_PIN_13|GPIO_PIN_0|GPIO_PIN_1, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, GPIO_PIN_10|GPIO_PIN_11|OE2_Pin|OE5_Pin
  ...
  /*Configure GPIO pins : OE1_Pin OE3_Pin OE4_Pin */
  GPIO_InitStruct.Pin = OE1_Pin|OE3_Pin|OE4_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  ...
  /*Configure GPIO pin : OE2_Pin */
  GPIO_InitStruct.Pin = OE2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(OE2_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : OE5_Pin */
  GPIO_InitStruct.Pin = OE5_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_MEDIUM;
  HAL_GPIO_Init(OE5_GPIO_Port, &GPIO_InitStruct);
