...
// 电磁阀完全开/关时间 ms
#define VAVLE_ACTION_TIME_MS 5000U
...
gpio_obj bottle2_in_valve_power__gpio = SIGNAL2_OUT_GPIO_DEF;
gpio_obj bottle3_in_valve_power__gpio = SIGNAL3_OUT_GPIO_DEF;
gpio_obj bottle4_in_valve_power__gpio = SIGNAL4_OUT_GPIO_DEF;
gpio_obj bottle5_in_valve_power__gpio = SIGNAL5_OUT_GPIO_DEF;
gpio_obj bottle6_in_valve_power__gpio = SIGNAL6_OUT_GPIO_DEF;
...
const gpio_obj* bootle_power_gpios[] = {
	...
	&bottle2_in_valve_power__gpio,
	&bottle3_in_valve_power__gpio,
	&bottle4_in_valve_power__gpio,
	&bottle5_in_valve_power__gpio,
	&bottle6_in_valve_power__gpio
};
