...
extern void mavlink_send_buff(uint8_t id, uint8_t* buf, uint32_t len);
#define MAVLINK_SEND_UART_BYTES(ch, buf, len) mavlink_send_buff((uint8_t)ch, (uint8_t*)buf, len)
